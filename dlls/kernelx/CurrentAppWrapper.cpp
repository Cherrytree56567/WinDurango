...
HRESULT CurrentAppWrapperX::RequestAppPurchaseAsync(
...
HRESULT CurrentAppWrapperX::RequestProductPurchaseAsync(
    HSTRING productId, boolean includeReceipt,
...
HRESULT CurrentAppWrapperX::GetProductReceiptAsync(
