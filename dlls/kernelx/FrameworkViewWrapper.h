...
{
  public:
    FrameworkViewWrapper(IFrameworkView *windowView) : m_realView(windowView)
    {
    }

    HRESULT STDMETHODCALLTYPE
    Initialize(ABI::Windows::ApplicationModel::Core::ICoreApplicationView *applicationView) override;
