...
ICoreWindowX : public IInspectable
{
  public:
    ...
    virtual INT32 _abi_add_Activated(ITypedEventHandler<CoreWindow *, WindowActivatedEventArgs *> * handler,
                                     EventRegistrationToken * token) = 0;
    virtual INT32 _abi_remove_Activated(EventRegistrationToken token) = 0;
    virtual INT32 _abi_add_CharacterReceived(ITypedEventHandler<CoreWindow *, CharacterReceivedEventArgs *> * handler,
                                             EventRegistrationToken * token) = 0;
    virtual INT32 _abi_remove_CharacterReceived(EventRegistrationToken token) = 0;
    virtual INT32 _abi_add_Closed(ITypedEventHandler<CoreWindow *, CoreWindowEventArgs *> * handler,
                                  EventRegistrationToken * token) = 0;
    virtual INT32 _abi_remove_Closed(EventRegistrationToken token) = 0;
    virtual INT32 _abi_add_InputEnabled(ITypedEventHandler<CoreWindow *, InputEnabledEventArgs *> * handler,
                                        EventRegistrationToken * token) = 0;
    virtual INT32 _abi_remove_InputEnabled(EventRegistrationToken token) = 0;
    virtual INT32 _abi_add_KeyDown(ITypedEventHandler<CoreWindow *, KeyEventArgs *> * handler,
                                   EventRegistrationToken * token) = 0;
    virtual INT32 _abi_remove_KeyDown(EventRegistrationToken token) = 0;
    virtual INT32 _abi_add_KeyUp(ITypedEventHandler<CoreWindow *, KeyEventArgs *> * handler,
                                 EventRegistrationToken * token) = 0;
    virtual INT32 _abi_remove_KeyUp(EventRegistrationToken token) = 0;
    virtual INT32 _abi_add_PointerMoved(ITypedEventHandler<CoreWindow *, PointerEventArgs *> * handler,
                                        EventRegistrationToken * token) = 0;
    virtual INT32 _abi_remove_PointerMoved(EventRegistrationToken token) = 0;
    virtual INT32 _abi_add_PointerEntered(ITypedEventHandler<CoreWindow *, PointerEventArgs *> * handler,
                                          EventRegistrationToken * token) = 0;
    virtual INT32 _abi_remove_PointerEntered(EventRegistrationToken token) = 0;
    virtual INT32 _abi_add_PointerExited(ITypedEventHandler<CoreWindow *, PointerEventArgs *> * handler,
                                         EventRegistrationToken * token) = 0;
    virtual INT32 _abi_remove_PointerExited(EventRegistrationToken token) = 0;
    virtual INT32 _abi_add_SizeChanged(ITypedEventHandler<CoreWindow *, WindowSizeChangedEventArgs *> * handler,
                                       EventRegistrationToken * token) = 0;
    virtual INT32 _abi_remove_SizeChanged(EventRegistrationToken token) = 0;
    virtual INT32 _abi_add_VisibilityChanged(ITypedEventHandler<CoreWindow *, VisibilityChangedEventArgs *> * handler,
                                             EventRegistrationToken * token) = 0;
