...
ULONG __stdcall EtxEventWrite_X(const EVENT_DESCRIPTOR_STRUCT *eventDescriptor,
                                const EVENT_PROVIDER_DESCRIPTOR * /*providerDescriptor*/, REGHANDLE handle,
                                ULONG dataCount, const EVENT_DATA_DESCRIPTOR *eventData)
{
    ...
    return EventWrite(handle, desc, dataCount, const_cast<PEVENT_DATA_DESCRIPTOR>(eventData));
}
