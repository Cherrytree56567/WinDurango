...
#include <Windows.h>
#include <mfapi.h>
// note from unixian: this proxy dll situation is temporary, but we need to use the actual functions from mfplat.dll
// while we're also named mfplat
#pragma region Proxy
struct mfplat_dll
{
    HMODULE dll;
...
extern "C"
{
    ...
    void fCopyPropVariant()
    {
        PA = mfplat.oCopyPropVariant;
        runASM();
    }
    void fCreatePropVariant()
    {
        PA = mfplat.oCreatePropVariant;
        runASM();
    }
    void fCreatePropertyStore()
    {
        PA = mfplat.oCreatePropertyStore;
        runASM();
    }
    void fDestroyPropVariant()
    {
        PA = mfplat.oDestroyPropVariant;
        runASM();
    }
    void fGetAMSubtypeFromD3DFormat()
    {
        PA = mfplat.oGetAMSubtypeFromD3DFormat;
        runASM();
    }
    void fGetD3DFormatFromMFSubtype()
    {
        PA = mfplat.oGetD3DFormatFromMFSubtype;
        runASM();
    }
    void fLFGetGlobalPool()
    {
        PA = mfplat.oLFGetGlobalPool;
        runASM();
    }
    void fMFAddPeriodicCallback()
    {
        PA = mfplat.oMFAddPeriodicCallback;
        runASM();
    }
    void fMFAllocateSerialWorkQueue()
    {
        PA = mfplat.oMFAllocateSerialWorkQueue;
        runASM();
    }
    void fMFAllocateWorkQueue()
    {
        PA = mfplat.oMFAllocateWorkQueue;
        runASM();
    }
    void fMFAllocateWorkQueueEx()
    {
        PA = mfplat.oMFAllocateWorkQueueEx;
        runASM();
    }
    void fMFAppendCollection()
    {
        PA = mfplat.oMFAppendCollection;
        runASM();
    }
    void fMFAverageTimePerFrameToFrameRate()
    {
        PA = mfplat.oMFAverageTimePerFrameToFrameRate;
        runASM();
    }
    void fMFBeginCreateFile()
    {
        PA = mfplat.oMFBeginCreateFile;
        runASM();
    }
    void fMFBlockThread()
    {
        PA = mfplat.oMFBlockThread;
        runASM();
    }
    void fMFCalculateBitmapImageSize()
    {
        PA = mfplat.oMFCalculateBitmapImageSize;
        runASM();
    }
    void fMFCalculateImageSize()
    {
        PA = mfplat.oMFCalculateImageSize;
        runASM();
    }
    void fMFCancelCreateFile()
    {
        PA = mfplat.oMFCancelCreateFile;
        runASM();
    }
    void fMFCancelWorkItem()
    {
        PA = mfplat.oMFCancelWorkItem;
        runASM();
    }
    void fMFConvertColorInfoFromDXVA()
    {
        PA = mfplat.oMFConvertColorInfoFromDXVA;
        runASM();
    }
    void fMFConvertColorInfoToDXVA()
    {
        PA = mfplat.oMFConvertColorInfoToDXVA;
        runASM();
    }
    void fMFConvertFromFP16Array()
    {
        PA = mfplat.oMFConvertFromFP16Array;
        runASM();
    }
    void fMFConvertToFP16Array()
    {
        PA = mfplat.oMFConvertToFP16Array;
        runASM();
    }
    void fMFCopyImage()
    {
        PA = mfplat.oMFCopyImage;
        runASM();
    }
    void fMFCreate2DMediaBuffer()
    {
        PA = mfplat.oMFCreate2DMediaBuffer;
        runASM();
    }
    void fMFCreateAMMediaTypeFromMFMediaType()
    {
        PA = mfplat.oMFCreateAMMediaTypeFromMFMediaType;
        runASM();
    }
    void fMFCreateAlignedMemoryBuffer()
    {
        PA = mfplat.oMFCreateAlignedMemoryBuffer;
        runASM();
    }
    void fMFCreateAsyncResult()
    {
        PA = mfplat.oMFCreateAsyncResult;
        runASM();
    }
    void fMFCreateAttributes()
    {
        PA = mfplat.oMFCreateAttributes;
        runASM();
    }
    void fMFCreateAudioMediaType()
    {
        PA = mfplat.oMFCreateAudioMediaType;
        runASM();
    }
    void fMFCreateCollection()
    {
        PA = mfplat.oMFCreateCollection;
        runASM();
    }
    void fMFCreateDXGIDeviceManager()
    {
        PA = mfplat.oMFCreateDXGIDeviceManager;
        runASM();
    }
    void fMFCreateDXGISurfaceBufferX()
    {
        PA = mfplat.oMFCreateDXGISurfaceBufferX;
        runASM();
    }
    void fMFCreateDxvaSampleRendererX()
    {
        PA = mfplat.oMFCreateDxvaSampleRendererX;
        runASM();
    }
    void fMFCreateEventQueue()
    {
        PA = mfplat.oMFCreateEventQueue;
        runASM();
    }
    void fMFCreateFile()
    {
        PA = mfplat.oMFCreateFile;
        runASM();
    }
    void fMFCreateFileFromHandle()
    {
        PA = mfplat.oMFCreateFileFromHandle;
        runASM();
    }
    void fMFCreateLegacyMediaBufferOnMFMediaBuffer()
    {
        PA = mfplat.oMFCreateLegacyMediaBufferOnMFMediaBuffer;
        runASM();
    }
    void fMFCreateMFByteStreamOnStream()
    {
        PA = mfplat.oMFCreateMFByteStreamOnStream;
        runASM();
    }
    void fMFCreateMFVideoFormatFromMFMediaType()
    {
        PA = mfplat.oMFCreateMFVideoFormatFromMFMediaType;
        runASM();
    }
    void fMFCreateMediaBufferFromMediaType()
    {
        PA = mfplat.oMFCreateMediaBufferFromMediaType;
        runASM();
    }
    void fMFCreateMediaBufferWrapper()
    {
        PA = mfplat.oMFCreateMediaBufferWrapper;
        runASM();
    }
    void fMFCreateMediaEvent()
    {
        PA = mfplat.oMFCreateMediaEvent;
        runASM();
    }
    void fMFCreateMediaEventResult()
    {
        PA = mfplat.oMFCreateMediaEventResult;
        runASM();
    }
    void fMFCreateMediaType()
    {
        PA = mfplat.oMFCreateMediaType;
        runASM();
    }
    void fMFCreateMediaTypeFromRepresentation()
    {
        PA = mfplat.oMFCreateMediaTypeFromRepresentation;
        runASM();
    }
    void fMFCreateMemoryBuffer()
    {
        PA = mfplat.oMFCreateMemoryBuffer;
        runASM();
    }
    void fMFCreateMemoryStream()
    {
        PA = mfplat.oMFCreateMemoryStream;
        runASM();
    }
    void fMFCreateNV12ToRGB32ConverterX()
    {
        PA = mfplat.oMFCreateNV12ToRGB32ConverterX;
        runASM();
    }
    void fMFCreatePathFromURL()
    {
        PA = mfplat.oMFCreatePathFromURL;
        runASM();
    }
    void fMFCreatePresentationDescriptor()
    {
        PA = mfplat.oMFCreatePresentationDescriptor;
        runASM();
    }
    void fMFCreateRGB32ToNV12ConverterX()
    {
        PA = mfplat.oMFCreateRGB32ToNV12ConverterX;
        runASM();
    }
    void fMFCreateSample()
    {
        PA = mfplat.oMFCreateSample;
        runASM();
    }
    void fMFCreateSourceResolver()
    {
        PA = mfplat.oMFCreateSourceResolver;
        runASM();
    }
    void fMFCreateSourceResolverInternal()
    {
        PA = mfplat.oMFCreateSourceResolverInternal;
        runASM();
    }
    void fMFCreateStreamDescriptor()
    {
        PA = mfplat.oMFCreateStreamDescriptor;
        runASM();
    }
    void fMFCreateSystemTimeSource()
    {
        PA = mfplat.oMFCreateSystemTimeSource;
        runASM();
    }
    void fMFCreateTempFile()
    {
        PA = mfplat.oMFCreateTempFile;
        runASM();
    }
    void fMFCreateTrackedSample()
    {
        PA = mfplat.oMFCreateTrackedSample;
        runASM();
    }
    void fMFCreateURLFromPath()
    {
        PA = mfplat.oMFCreateURLFromPath;
        runASM();
    }
    void fMFCreateVideoMediaType()
    {
        PA = mfplat.oMFCreateVideoMediaType;
        runASM();
    }
    void fMFCreateVideoMediaTypeFromBitMapInfoHeader()
    {
        PA = mfplat.oMFCreateVideoMediaTypeFromBitMapInfoHeader;
        runASM();
    }
    ...
    void fMFCreateVideoMediaTypeFromSubtype()
    {
        PA = mfplat.oMFCreateVideoMediaTypeFromSubtype;
        runASM();
    }
    void fMFCreateVideoMediaTypeFromVideoInfoHeader()
    {
        PA = mfplat.oMFCreateVideoMediaTypeFromVideoInfoHeader;
        runASM();
    }
    void fMFCreateVideoMediaTypeFromVideoInfoHeader2()
    {
        PA = mfplat.oMFCreateVideoMediaTypeFromVideoInfoHeader2;
        runASM();
    }
    void fMFCreateVideoSampleAllocatorEx()
    {
        PA = mfplat.oMFCreateVideoSampleAllocatorEx;
        runASM();
    }
    void fMFCreateWaveFormatExFromMFMediaType()
    {
        PA = mfplat.oMFCreateWaveFormatExFromMFMediaType;
        runASM();
    }
    void fMFDeserializeAttributesFromStream()
    {
        PA = mfplat.oMFDeserializeAttributesFromStream;
        runASM();
    }
    void fMFDeserializeEvent()
    {
        PA = mfplat.oMFDeserializeEvent;
        runASM();
    }
    void fMFDeserializeMediaTypeFromStream()
    {
        PA = mfplat.oMFDeserializeMediaTypeFromStream;
        runASM();
    }
    void fMFDeserializePresentationDescriptor()
    {
        PA = mfplat.oMFDeserializePresentationDescriptor;
        runASM();
    }
    void fMFEndCreateFile()
    {
        PA = mfplat.oMFEndCreateFile;
        runASM();
    }
    void fMFFrameRateToAverageTimePerFrame()
    {
        PA = mfplat.oMFFrameRateToAverageTimePerFrame;
        runASM();
    }
    void fMFGetAttributesAsBlob()
    {
        PA = mfplat.oMFGetAttributesAsBlob;
        runASM();
    }
    void fMFGetAttributesAsBlobSize()
    {
        PA = mfplat.oMFGetAttributesAsBlobSize;
        runASM();
    }
    void fMFGetConfigurationDWORD()
    {
        PA = mfplat.oMFGetConfigurationDWORD;
        runASM();
    }
    void fMFGetConfigurationPolicy()
    {
        PA = mfplat.oMFGetConfigurationPolicy;
        runASM();
    }
    void fMFGetConfigurationStore()
    {
        PA = mfplat.oMFGetConfigurationStore;
        runASM();
    }
    void fMFGetConfigurationString()
    {
        PA = mfplat.oMFGetConfigurationString;
        runASM();
    }
    void fMFGetPlaneSize()
    {
        PA = mfplat.oMFGetPlaneSize;
        runASM();
    }
    void fMFGetPlatform()
    {
        PA = mfplat.oMFGetPlatform;
        runASM();
    }
    void fMFGetPrivateWorkqueues()
    {
        PA = mfplat.oMFGetPrivateWorkqueues;
        runASM();
    }
    void fMFGetStrideForBitmapInfoHeader()
    {
        PA = mfplat.oMFGetStrideForBitmapInfoHeader;
        runASM();
    }
    void fMFGetSupportedMimeTypes()
    {
        PA = mfplat.oMFGetSupportedMimeTypes;
        runASM();
    }
    void fMFGetSupportedSchemes()
    {
        PA = mfplat.oMFGetSupportedSchemes;
        runASM();
    }
    void fMFGetSystemTime()
    {
        PA = mfplat.oMFGetSystemTime;
        runASM();
    }
    void fMFGetTimerPeriodicity()
    {
        PA = mfplat.oMFGetTimerPeriodicity;
        runASM();
    }
    void fMFGetUncompressedVideoFormat()
    {
        PA = mfplat.oMFGetUncompressedVideoFormat;
        runASM();
    }
    void fMFGetWorkQueueMMCSSTaskId()
    {
        PA = mfplat.oMFGetWorkQueueMMCSSTaskId;
        runASM();
    }
    void fMFHeapAlloc()
    {
        PA = mfplat.oMFHeapAlloc;
        runASM();
    }
    void fMFHeapFree()
    {
        PA = mfplat.oMFHeapFree;
        runASM();
    }
    void fMFInitAMMediaTypeFromMFMediaType()
    {
        PA = mfplat.oMFInitAMMediaTypeFromMFMediaType;
        runASM();
    }
    void fMFInitAttributesFromBlob()
    {
        PA = mfplat.oMFInitAttributesFromBlob;
        runASM();
    }
    void fMFInitMediaTypeFromAMMediaType()
    {
        PA = mfplat.oMFInitMediaTypeFromAMMediaType;
        runASM();
    }
    void fMFInitMediaTypeFromMFVideoFormat()
    {
        PA = mfplat.oMFInitMediaTypeFromMFVideoFormat;
        runASM();
    }
    void fMFInitMediaTypeFromVideoInfoHeader()
    {
        PA = mfplat.oMFInitMediaTypeFromVideoInfoHeader;
        runASM();
    }
    void fMFInitMediaTypeFromVideoInfoHeader2()
    {
        PA = mfplat.oMFInitMediaTypeFromVideoInfoHeader2;
        runASM();
    }
    void fMFInitMediaTypeFromWaveFormatEx()
    {
        PA = mfplat.oMFInitMediaTypeFromWaveFormatEx;
        runASM();
    }
    void fMFInitVideoFormat()
    {
        PA = mfplat.oMFInitVideoFormat;
        runASM();
    }
    void fMFInitVideoFormat_RGB()
    {
        PA = mfplat.oMFInitVideoFormat_RGB;
        runASM();
    }
    void fMFInvokeCallback()
    {
        PA = mfplat.oMFInvokeCallback;
        runASM();
    }
    void fMFJoinIoPort()
    {
        PA = mfplat.oMFJoinIoPort;
        runASM();
    }
    void fMFJoinWorkQueue()
    {
        PA = mfplat.oMFJoinWorkQueue;
        runASM();
    }
    void fMFLockDXGIDeviceManager()
    {
        PA = mfplat.oMFLockDXGIDeviceManager;
        runASM();
    }
    void fMFLockPlatform()
    {
        PA = mfplat.oMFLockPlatform;
        runASM();
    }
    void fMFLockSharedWorkQueue()
    {
        PA = mfplat.oMFLockSharedWorkQueue;
        runASM();
    }
    void fMFLockWorkQueue()
    {
        PA = mfplat.oMFLockWorkQueue;
        runASM();
    }
    void fMFMapDX9FormatToDXGIFormat()
    {
        PA = mfplat.oMFMapDX9FormatToDXGIFormat;
        runASM();
    }
    void fMFMapDXGIFormatToDX9Format()
    {
        PA = mfplat.oMFMapDXGIFormatToDX9Format;
        runASM();
    }
    void fMFPutWaitingWorkItem()
    {
        PA = mfplat.oMFPutWaitingWorkItem;
        runASM();
    }
    void fMFPutWorkItem()
    {
        PA = mfplat.oMFPutWorkItem;
        runASM();
    }
    void fMFPutWorkItem2()
    {
        PA = mfplat.oMFPutWorkItem2;
        runASM();
    }
    void fMFPutWorkItemEx()
    {
        PA = mfplat.oMFPutWorkItemEx;
        runASM();
    }
    void fMFPutWorkItemEx2()
    {
        PA = mfplat.oMFPutWorkItemEx2;
        runASM();
    }
    void fMFRemovePeriodicCallback()
    {
        PA = mfplat.oMFRemovePeriodicCallback;
        runASM();
    }

    HRESULT __stdcall MFResetDXGIDeviceManager_X(IMFDXGIDeviceManager *pDeviceManager, IUnknown *pD3DDevice,
                                                 UINT resetToken)
    {
    ...
    void fMFScheduleWorkItem()
    {
        PA = mfplat.oMFScheduleWorkItem;
        runASM();
    }
    void fMFScheduleWorkItemEx()
    {
        PA = mfplat.oMFScheduleWorkItemEx;
        runASM();
    }
    void fMFSerializeAttributesToStream()
    {
        PA = mfplat.oMFSerializeAttributesToStream;
        runASM();
    }
    void fMFSerializeEvent()
    {
        PA = mfplat.oMFSerializeEvent;
        runASM();
    }
    void fMFSerializeMediaTypeToStream()
    {
        PA = mfplat.oMFSerializeMediaTypeToStream;
        runASM();
    }
    void fMFSerializePresentationDescriptor()
    {
        PA = mfplat.oMFSerializePresentationDescriptor;
        runASM();
    }
    void fMFShutdown()
    {
        PA = mfplat.oMFShutdown;
        runASM();
    }
    ...
    void fMFTEnumEx()
    {
        PA = mfplat.oMFTEnumEx;
        runASM();
    }
    void fMFTraceError()
    {
        PA = mfplat.oMFTraceError;
        runASM();
    }
    void fMFTraceFuncEnter()
    {
        PA = mfplat.oMFTraceFuncEnter;
        runASM();
    }
    void fMFUnblockThread()
    {
        PA = mfplat.oMFUnblockThread;
        runASM();
    }
    void fMFUnjoinWorkQueue()
    {
        PA = mfplat.oMFUnjoinWorkQueue;
        runASM();
    }
    void fMFUnlockDXGIDeviceManager()
    {
        PA = mfplat.oMFUnlockDXGIDeviceManager;
        runASM();
    }
    void fMFUnlockPlatform()
    {
        PA = mfplat.oMFUnlockPlatform;
        runASM();
    }
    void fMFUnlockWorkQueue()
    {
        PA = mfplat.oMFUnlockWorkQueue;
        runASM();
    }
    void fMFUnwrapMediaType()
    {
        PA = mfplat.oMFUnwrapMediaType;
        runASM();
    }
    void fMFValidateMediaTypeSize()
    {
        PA = mfplat.oMFValidateMediaTypeSize;
        runASM();
    }
    void fMFWrapMediaType()
    {
        PA = mfplat.oMFWrapMediaType;
        runASM();
    }
    void fMFllMulDiv()
    {
        PA = mfplat.oMFllMulDiv;
        runASM();
    }
    void fPropVariantFromStream()
    {
        PA = mfplat.oPropVariantFromStream;
        runASM();
    }
    void fPropVariantToStream()
    {
        PA = mfplat.oPropVariantToStream;
        runASM();
    }
    void fValidateWaveFormat()
    {
        PA = mfplat.oValidateWaveFormat;
        runASM();
    }
}
...
void setupFunctions()
{
    ...
    mfplat.oMFCreateLegacyMediaBufferOnMFMediaBuffer =
        GetProcAddress(mfplat.dll, "MFCreateLegacyMediaBufferOnMFMediaBuffer");
    ...
    mfplat.oMFCreateVideoMediaTypeFromBitMapInfoHeader =
    ...
    mfplat.oMFCreateVideoMediaTypeFromVideoInfoHeader =
        GetProcAddress(mfplat.dll, "MFCreateVideoMediaTypeFromVideoInfoHeader");
    mfplat.oMFCreateVideoMediaTypeFromVideoInfoHeader2 =
