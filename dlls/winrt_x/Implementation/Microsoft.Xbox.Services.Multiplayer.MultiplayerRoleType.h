...
struct MultiplayerRoleType : MultiplayerRoleTypeT<MultiplayerRoleType>
{
    ...
    winrt::Windows::Foundation::Collections::IVectorView<
        winrt::Microsoft::Xbox::Services::Multiplayer::MutableRoleSetting>
    MutableRoleSettings();
    winrt::Windows::Foundation::Collections::IMapView<
        hstring, winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerRoleInfo>
    Roles();
    void Roles(winrt::Windows::Foundation::Collections::IMapView<
