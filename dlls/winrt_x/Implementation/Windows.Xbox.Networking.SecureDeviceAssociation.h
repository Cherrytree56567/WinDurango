...
struct SecureDeviceAssociation : SecureDeviceAssociationT<SecureDeviceAssociation>
{
    ...
    static winrt::Windows::Xbox::Networking::SecureDeviceAssociation GetAssociationBySocketAddressBytes(
        array_view<uint8_t const> remoteSocketAddressBytes, array_view<uint8_t const> localSocketAddressBytes);
    static winrt::Windows::Xbox::Networking::SecureDeviceAssociation GetAssociationByHostNamesAndPorts(
        winrt::Windows::Networking::HostName const &remoteHostName, hstring const &remotePort,
        winrt::Windows::Networking::HostName const &localHostName, hstring const &localPort);
    winrt::event_token StateChanged(
        winrt::Windows::Foundation::TypedEventHandler<
            winrt::Windows::Xbox::Networking::SecureDeviceAssociation,
            winrt::Windows::Xbox::Networking::SecureDeviceAssociationStateChangedEventArgs> const &handler);
...
{
struct SecureDeviceAssociation
    : SecureDeviceAssociationT<SecureDeviceAssociation, implementation::SecureDeviceAssociation>
{
};
} // namespace winrt::Windows::Xbox::Networking::factory_implementation
