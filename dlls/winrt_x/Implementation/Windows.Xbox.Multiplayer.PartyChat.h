...
struct PartyChat
{
    ...
    static winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Xbox::Multiplayer::PartyChatView>
    GetPartyChatViewAsync();
    static winrt::event_token PartyChatViewChanged(
    ...
    static winrt::event_token IsPartyChatSuppressedChanged(
