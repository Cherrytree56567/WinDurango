...
struct RealTimeActivityService : RealTimeActivityServiceT<RealTimeActivityService>
{
    ...
    void Activate();
    void Deactivate();
    winrt::event_token RealTimeActivityConnectionStateChange(
    ...
    winrt::event_token RealTimeActivitySubscriptionError(
        winrt::Windows::Foundation::EventHandler<
            winrt::Microsoft::Xbox::Services::RealTimeActivity::RealTimeActivitySubscriptionErrorEventArgs> const
            &__param0);
    void RealTimeActivitySubscriptionError(winrt::event_token const &__param0) noexcept;
    winrt::event_token RealTimeActivityResync(
        winrt::Windows::Foundation::EventHandler<
