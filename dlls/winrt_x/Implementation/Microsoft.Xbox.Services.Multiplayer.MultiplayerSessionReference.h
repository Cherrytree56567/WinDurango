...
struct MultiplayerSessionReference : MultiplayerSessionReferenceT<MultiplayerSessionReference>
{
    ...
    MultiplayerSessionReference(hstring const &serviceConfigurationId, hstring const &sessionTemplateName,
                                hstring const &sessionName);
    static winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerSessionReference ParseFromUriPath(
        hstring const &uriPath);
