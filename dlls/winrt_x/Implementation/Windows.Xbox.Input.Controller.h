...
struct Controller : ControllerT<Controller>
{
    ...
    static void GetControllerMetadata(uint64_t controllerId,
    ...
    inline static winrt::Windows::Foundation::Collections::IVector<winrt::Windows::Xbox::Input::IController>
        staticControllers = {nullptr};
};
} // namespace winrt::Windows::Xbox::Input::implementation
