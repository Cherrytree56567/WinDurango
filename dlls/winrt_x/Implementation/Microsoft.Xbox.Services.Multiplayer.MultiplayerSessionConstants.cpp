...
winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerSessionVisibility MultiplayerSessionConstants::
    MultiplayerSessionVisibility()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
void MultiplayerSessionConstants::MultiplayerSessionVisibility(
    winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerSessionVisibility const &value)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
...
winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerManagedInitialization MultiplayerSessionConstants::
    ManagedInitialization()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerMemberInitialization MultiplayerSessionConstants::
    MemberInitialization()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerPeerToPeerRequirements MultiplayerSessionConstants::
    PeerToPeerRequirements()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerPeerToHostRequirements MultiplayerSessionConstants::
