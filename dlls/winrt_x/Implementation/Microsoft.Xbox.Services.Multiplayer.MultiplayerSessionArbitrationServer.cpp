...
winrt::Microsoft::Xbox::Services::Tournaments::TournamentArbitrationState MultiplayerSessionArbitrationServer::
    ResultState()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
winrt::Microsoft::Xbox::Services::Tournaments::TournamentGameResultSource MultiplayerSessionArbitrationServer::
    ResultSource()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
...
MultiplayerSessionArbitrationServer::Results()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
