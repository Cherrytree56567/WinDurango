...
struct SpeechGrammarBuilderRuleSet : SpeechGrammarBuilderRuleSetT<SpeechGrammarBuilderRuleSet>
{
    ...
    void Split(winrt::Windows::Foundation::Collections::IMapView<
                   hstring, winrt::Windows::Xbox::Speech::Recognition::ISpeechRule> &first,
               winrt::Windows::Foundation::Collections::IMapView<
                   hstring, winrt::Windows::Xbox::Speech::Recognition::ISpeechRule> &second);
    winrt::Windows::Xbox::Speech::Recognition::SpeechChoiceRule AddChoiceRule(
    ...
    winrt::Windows::Xbox::Speech::Recognition::SpeechSequenceRule AddSequenceRule(
        hstring const &key, winrt::Windows::Foundation::Collections::IIterable<
                                winrt::Windows::Xbox::Speech::Recognition::ISpeechRuleItem> const &items);
