...
winrt::Windows::Xbox::System::User winrt::Windows::Xbox::ApplicationModel::Core::implementation::
    CoreApplicationContext::PreviousUser()
{
    return g_previousUser;
}
winrt::event_token CoreApplicationContext::CurrentUserChanged(
...
winrt::event_token CoreApplicationContext::CurrentSystemUserChanged(
    winrt::Windows::Foundation::EventHandler<winrt::Windows::Foundation::IInspectable> const &handler)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
