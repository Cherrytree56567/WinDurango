...
winrt::event_token SmartGlassTextEntrySurface::TextChanged(
    winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Xbox::SmartGlass::SmartGlassTextEntrySurface,
                                                  winrt::Windows::Xbox::SmartGlass::SmartGlassTextEntryEventArgs> const
        &handler)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
...
winrt::event_token SmartGlassTextEntrySurface::TextEntryFinished(
    winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Xbox::SmartGlass::SmartGlassTextEntrySurface,
                                                  winrt::Windows::Xbox::SmartGlass::SmartGlassTextEntryEventArgs> const
        &handler)
{
