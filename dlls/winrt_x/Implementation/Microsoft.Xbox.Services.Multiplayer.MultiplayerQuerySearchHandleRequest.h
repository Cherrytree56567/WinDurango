...
{
struct MultiplayerQuerySearchHandleRequest
    : MultiplayerQuerySearchHandleRequestT<MultiplayerQuerySearchHandleRequest,
                                           implementation::MultiplayerQuerySearchHandleRequest>
{
};
} // namespace winrt::Microsoft::Xbox::Services::Multiplayer::factory_implementation
