...
winrt::Windows::Foundation::Collections::IObservableMap<hstring, winrt::Windows::Kinect::KinectSensor> KinectSensor::
    Sensors()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
winrt::event_token KinectSensor::IsPausedChanged(
    winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Kinect::KinectSensor,
                                                  winrt::Windows::Kinect::IsPausedChangedEventArgs> const &value)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
...
winrt::Windows::Kinect::MultiSourceFrameReader KinectSensor::OpenMultiSourceFrameReader(
    winrt::Windows::Kinect::FrameSourceTypes const &enabledFrameSourceTypes)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
