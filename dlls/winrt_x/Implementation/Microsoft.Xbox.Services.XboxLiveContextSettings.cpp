...
{
winrt::event_token XboxLiveContextSettings::ServiceCallRouted(
    winrt::Windows::Foundation::EventHandler<winrt::Microsoft::Xbox::Services::XboxServiceCallRoutedEventArgs> const
        &__param0)
{
    LOG_NOT_IMPLEMENTED();
...
void XboxLiveContextSettings::DiagnosticsTraceLevel(
    winrt::Microsoft::Xbox::Services::XboxServicesDiagnosticsTraceLevel const &value)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
...
void XboxLiveContextSettings::DisableAssertsForXboxLiveThrottlingInDevSandboxes(
    winrt::Microsoft::Xbox::Services::XboxLiveContextThrottleSetting const &setting)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
void XboxLiveContextSettings::DisableAssertsForMaximumNumberOfWebsocketsActivated(
    winrt::Microsoft::Xbox::Services::XboxLiveContextRecommendedSetting const &setting)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
