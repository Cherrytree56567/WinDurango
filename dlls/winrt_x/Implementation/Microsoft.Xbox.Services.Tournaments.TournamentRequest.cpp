...
winrt::Windows::Foundation::Collections::IVectorView<winrt::Microsoft::Xbox::Services::Tournaments::TournamentState>
TournamentRequest::StateFilter()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
void TournamentRequest::StateFilter(winrt::Windows::Foundation::Collections::IVectorView<
                                    winrt::Microsoft::Xbox::Services::Tournaments::TournamentState> const &states)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
