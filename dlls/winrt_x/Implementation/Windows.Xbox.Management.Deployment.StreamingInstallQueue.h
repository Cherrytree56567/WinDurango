...
struct StreamingInstallQueue : StreamingInstallQueueT<StreamingInstallQueue>
{
    ...
    winrt::Windows::Xbox::Management::Deployment::IStreamingPackage GetStreamingPackage(
        hstring const &packageInstanceId);
    winrt::event_token QueueChanged(
    ...
    winrt::event_token StreamingPackageStateChanged(
        winrt::Windows::Foundation::EventHandler<
