...
struct SpeechRecognizerFactory
{
    ...
    static winrt::Windows::Xbox::Speech::Recognition::SpeechRecognizer CreateSpeechRecognizerForLocale(
...
{
struct SpeechRecognizerFactory
    : SpeechRecognizerFactoryT<SpeechRecognizerFactory, implementation::SpeechRecognizerFactory>
{
};
} // namespace winrt::Windows::Xbox::Speech::Recognition::factory_implementation
