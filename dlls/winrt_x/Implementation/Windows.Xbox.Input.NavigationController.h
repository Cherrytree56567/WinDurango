...
struct NavigationController : NavigationControllerT<NavigationController>
{
    ...
    static winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Xbox::Input::INavigationController>
    NavigationControllers();
    static winrt::event_token NavigationControllerAdded(
    ...
    static winrt::event_token NavigationControllerRemoved(
        winrt::Windows::Foundation::EventHandler<
            winrt::Windows::Xbox::Input::NavigationControllerRemovedEventArgs> const &handler);
