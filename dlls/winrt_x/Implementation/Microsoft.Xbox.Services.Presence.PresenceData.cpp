...
{
    LOG_WARNING("[PresenceData] PresenceData::PresenceData(hstring const& serviceConfigurationId, hstring const& "
                "presenceId) called\n");
}
PresenceData::PresenceData(hstring const &serviceConfigurationId, hstring const &presenceId,
                           winrt::Windows::Foundation::Collections::IVectorView<hstring> const &presenceTokenIds)
{
    LOG_NOT_IMPLEMENTED();
