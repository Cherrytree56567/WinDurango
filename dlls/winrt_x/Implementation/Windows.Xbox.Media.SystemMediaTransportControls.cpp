...
winrt::event_token SystemMediaTransportControls::ButtonPressed(
    winrt::Windows::Foundation::TypedEventHandler<
        winrt::Windows::Xbox::Media::SystemMediaTransportControls,
        winrt::Windows::Xbox::Media::SystemMediaTransportControlsButtonPressedEventArgs> const &handler)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
...
winrt::event_token SystemMediaTransportControls::PropertyChanged(
    winrt::Windows::Foundation::TypedEventHandler<
        winrt::Windows::Xbox::Media::SystemMediaTransportControls,
        winrt::Windows::Xbox::Media::SystemMediaTransportControlsPropertyChangedEventArgs> const &handler)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
