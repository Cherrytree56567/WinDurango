...
ContainerInfoQueryResult::GetContainerInfoAsync(uint32_t startIndex, uint32_t maxNumberOfItems)
{
    LOG_NOT_IMPLEMENTED();
...
winrt::Windows::Foundation::IAsyncOperation<
    winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Xbox::Storage::ContainerInfo>>
ContainerInfoQueryResult::GetContainerInfoAsync()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
...
ContainerInfoQueryResult::GetContainerInfo2Async(uint32_t startIndex, uint32_t maxNumberOfItems)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
winrt::Windows::Foundation::IAsyncOperation<
    winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Xbox::Storage::ContainerInfo2>>
ContainerInfoQueryResult::GetContainerInfo2Async()
{
