...
struct SecureDeviceAssociationTemplate : SecureDeviceAssociationTemplateT<SecureDeviceAssociationTemplate>
{
    ...
    Templates();
    winrt::event_token AssociationIncoming(
    ...
    CreateAssociationAsync(winrt::Windows::Xbox::Networking::SecureDeviceAddress secureDeviceAddress,
                           winrt::Windows::Xbox::Networking::CreateSecureDeviceAssociationBehavior behavior);
    winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Xbox::Networking::SecureDeviceAssociation>
    CreateAssociationForPortsAsync(winrt::Windows::Xbox::Networking::SecureDeviceAddress secureDeviceAddress,
                                   winrt::Windows::Xbox::Networking::CreateSecureDeviceAssociationBehavior behavior,
                                   hstring initiatorPort, hstring acceptorPort);
    winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::Streams::IBuffer>
    CreateCertificateRequestAsync(hstring subjectName);
    winrt::Windows::Foundation::IAsyncAction InstallCertificateAsync(
...
{
struct SecureDeviceAssociationTemplate
    : SecureDeviceAssociationTemplateT<SecureDeviceAssociationTemplate, implementation::SecureDeviceAssociationTemplate>
{
};
} // namespace winrt::Windows::Xbox::Networking::factory_implementation
