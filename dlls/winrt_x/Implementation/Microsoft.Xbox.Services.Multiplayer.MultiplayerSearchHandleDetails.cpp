...
{
winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerSessionReference MultiplayerSearchHandleDetails::
    SessionReference()
{
    LOG_NOT_IMPLEMENTED();
...
MultiplayerSearchHandleDetails::RoleTypes()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
...
winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerSessionRestriction MultiplayerSearchHandleDetails::
    JoinRestriction()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
