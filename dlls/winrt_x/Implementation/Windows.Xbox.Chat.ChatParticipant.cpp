...
void ChatParticipant::SynthesizeTextMessageAsAudioBuffers(
    hstring const &message, winrt::Windows::Media::SpeechSynthesis::VoiceInformation const &preferredVoice)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
