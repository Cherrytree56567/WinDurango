...
{
winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerSessionReference MultiplayerActivityDetails::
    SessionReference()
{
    LOG_NOT_IMPLEMENTED();
...
winrt::Microsoft::Xbox::Services::Multiplayer::MultiplayerSessionRestriction MultiplayerActivityDetails::
    JoinRestriction()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
