...
struct XboxLiveServicesSettings : XboxLiveServicesSettingsT<XboxLiveServicesSettings>
{
    ...
    winrt::event_token LogCallRouted(
    ...
    winrt::event_token WnsEventRecevied(
        winrt::Windows::Foundation::EventHandler<winrt::Microsoft::Xbox::Services::XboxLiveWnsEventArgs> const
            &__param0);
...
{
struct XboxLiveServicesSettings
    : XboxLiveServicesSettingsT<XboxLiveServicesSettings, implementation::XboxLiveServicesSettings>
{
};
} // namespace winrt::Microsoft::Xbox::Services::System::factory_implementation
