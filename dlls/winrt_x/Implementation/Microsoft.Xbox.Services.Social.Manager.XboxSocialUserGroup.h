...
struct XboxSocialUserGroup : XboxSocialUserGroupT<XboxSocialUserGroup>
{
    ...
    winrt::Windows::Foundation::Collections::IVectorView<
        winrt::Microsoft::Xbox::Services::Social::Manager::XboxSocialUser>
    Users();
    ...
    winrt::Windows::Foundation::Collections::IVectorView<
        winrt::Microsoft::Xbox::Services::Social::Manager::XboxSocialUser>
    GetUsersFromXboxUserIds(winrt::Windows::Foundation::Collections::IVectorView<hstring> const &xboxUserIds);
};
} // namespace winrt::Microsoft::Xbox::Services::Social::Manager::implementation
