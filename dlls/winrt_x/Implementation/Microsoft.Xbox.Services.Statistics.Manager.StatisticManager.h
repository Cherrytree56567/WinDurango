...
struct StatisticManager : StatisticManagerT<StatisticManager>
{
    ...
    void SetStatisticStringData(winrt::Windows::Xbox::System::User const &user, hstring const &name,
                                hstring const &value);
    winrt::Windows::Foundation::Collections::IVectorView<hstring> GetStatisticNames(
        winrt::Windows::Xbox::System::User const &user);
    winrt::Microsoft::Xbox::Services::Statistics::Manager::StatisticValue GetStatistic(
    ...
    void GetLeaderboard(winrt::Windows::Xbox::System::User const &user, hstring const &statName,
                        winrt::Microsoft::Xbox::Services::Leaderboard::LeaderboardQuery const &query);
    void GetSocialLeaderboard(winrt::Windows::Xbox::System::User const &user, hstring const &statName,
                              hstring const &socialGroup,
                              winrt::Microsoft::Xbox::Services::Leaderboard::LeaderboardQuery const &query);
};
} // namespace winrt::Microsoft::Xbox::Services::Statistics::Manager::implementation
