...
winrt::Windows::Foundation::Collections::IIterator<winrt::Windows::Foundation::Collections::IKeyValuePair<
    hstring, winrt::Windows::Xbox::Speech::Recognition::ISpeechRule>>
SpeechGrammarBuilderRuleSet::First()
{
    LOG_NOT_IMPLEMENTED();
...
void SpeechGrammarBuilderRuleSet::Split(
    winrt::Windows::Foundation::Collections::IMapView<hstring, winrt::Windows::Xbox::Speech::Recognition::ISpeechRule>
        &first,
    winrt::Windows::Foundation::Collections::IMapView<hstring, winrt::Windows::Xbox::Speech::Recognition::ISpeechRule>
        &second)
{
...
winrt::Windows::Xbox::Speech::Recognition::SpeechChoiceRule SpeechGrammarBuilderRuleSet::AddChoiceRule(
...
winrt::Windows::Xbox::Speech::Recognition::SpeechSequenceRule SpeechGrammarBuilderRuleSet::AddSequenceRule(
    hstring const &key,
    winrt::Windows::Foundation::Collections::IIterable<winrt::Windows::Xbox::Speech::Recognition::ISpeechRuleItem> const
        &items)
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
