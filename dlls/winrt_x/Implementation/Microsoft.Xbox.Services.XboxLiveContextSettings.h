...
struct XboxLiveContextSettings : XboxLiveContextSettingsT<XboxLiveContextSettings>
{
    ...
    winrt::event_token ServiceCallRouted(
    ...
    void DisableAssertsForMaximumNumberOfWebsocketsActivated(
...
{
struct XboxLiveContextSettings
    : XboxLiveContextSettingsT<XboxLiveContextSettings, implementation::XboxLiveContextSettings>
{
};
} // namespace winrt::Microsoft::Xbox::Services::factory_implementation
