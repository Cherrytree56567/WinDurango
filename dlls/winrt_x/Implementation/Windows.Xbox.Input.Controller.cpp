...
{
    winrt::Windows::Foundation::Collections::IVector<winrt::Windows::Xbox::Input::IController> vector =
        winrt::single_threaded_vector<Input::IController>();
...
winrt::event_token Controller::ControllerAdded(
    winrt::Windows::Foundation::EventHandler<winrt::Windows::Xbox::Input::ControllerAddedEventArgs> const &handler)
{
...
winrt::event_token Controller::ControllerRemoved(
    winrt::Windows::Foundation::EventHandler<winrt::Windows::Xbox::Input::ControllerRemovedEventArgs> const &handler)
{
...
winrt::event_token Controller::ControllerPairingChanged(
    winrt::Windows::Foundation::EventHandler<winrt::Windows::Xbox::Input::ControllerPairingChangedEventArgs> const
        &handler)
{
...
winrt::event_token Controller::ControllerOrderChanged(
...
void Controller::GetControllerMetadata(uint64_t controllerId,
                                       winrt::Windows::Xbox::Input::MetadataVersion const &metadataVersion,
                                       com_array<uint8_t> &ppMetadata)
{
    LOG_INFO_W(L"Controller || GetControllerMetadata!\n");
    throw hresult_not_implemented();
}
winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Xbox::Input::IController> Controller::
    GetControllersOrderedLeftToRight(winrt::Windows::Xbox::Input::ControllerOrderFilter const &orderFilter)
{
...
winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Xbox::System::IAudioDeviceInfo> Controller::
    AudioDevices()
{
