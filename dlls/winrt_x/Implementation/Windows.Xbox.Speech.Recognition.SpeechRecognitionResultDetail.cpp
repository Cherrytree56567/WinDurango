...
winrt::Windows::Foundation::Collections::IVectorView<
    winrt::Windows::Xbox::Speech::Recognition::SpeechRecognitionResultToken>
SpeechRecognitionResultDetail::Tokens()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
...
winrt::Windows::Foundation::Collections::IVectorView<
    winrt::Windows::Xbox::Speech::Recognition::SpeechRecognitionResultBodyCorrelation>
SpeechRecognitionResultDetail::BodyCorrelation()
{
    LOG_NOT_IMPLEMENTED();
    throw hresult_not_implemented();
}
