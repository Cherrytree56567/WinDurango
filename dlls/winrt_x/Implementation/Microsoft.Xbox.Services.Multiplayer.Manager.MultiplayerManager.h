...
struct MultiplayerManager : MultiplayerManagerT<MultiplayerManager>
{
    ...
    void FindMatch(hstring const &hopperName, hstring const &attributes,
    ...
    void JoinLobby(
        ...
        winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Xbox::System::User> const &users);
    void JoinLobby(winrt::Windows::ApplicationModel::Activation::IProtocolActivatedEventArgs const &eventArgs,
