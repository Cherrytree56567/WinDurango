...
winrt::Windows::Foundation::IAsyncAction WinDurango::impl::ConnectedStorage::Read(
    ...
    winrt::Windows::Foundation::Collections::IMapView<winrt::hstring, winrt::Windows::Storage::Streams::IBuffer> data)
    const
{
    if (data == nullptr)
    {
            ...
            try
            {
                ...
                if (dataBuffer.Capacity() < fileBuffer.Length())
                {
                    LOG_ERROR("[ConnectedStorage] Buffer too small for file %S (need %u, have %u)\n", fileName.c_str(),
                              fileBuffer.Length(), dataBuffer.Capacity());
                    continue;
                }
...
winrt::Windows::Foundation::IAsyncAction WinDurango::impl::ConnectedStorage::Upload(
    winrt::hstring containerName,
    winrt::Windows::Foundation::Collections::IMapView<winrt::hstring, winrt::Windows::Storage::Streams::IBuffer>
        blobsToWrite,
    winrt::Windows::Foundation::Collections::IIterable<winrt::hstring> blobsToDelete, winrt::hstring displayName) const
{
    if (m_storagePath.empty())
    {
        LOG_ERROR("[ConnectedStorage] Storage path not initialized\n");
        ...
        if (!displayName.empty())
        {
            try
            {
                auto file = co_await folder.CreateFileAsync(
                    L"wd_displayname.txt", winrt::Windows::Storage::CreationCollisionOption::ReplaceExisting);
...
WinDurango::impl::ConnectedStorage::GetBlobInfoAsync(winrt::hstring parentContainerName, winrt::hstring blobNamePrefix)
{
...
winrt::Windows::Foundation::IAsyncAction WinDurango::impl::ConnectedStorage::DeleteContainer(
    winrt::hstring containerName)
{
    if (m_storagePath.empty())
    {
...
winrt::Windows::Foundation::IAsyncAction WinDurango::impl::ConnectedStorage::CreateDirectories(
    const wchar_t *storageType, winrt::hstring &storagePath)
{
    ...
    try
    {
        ...
        {
            auto winDurangoFolder =
                co_await winrt::Windows::Storage::StorageFolder::GetFolderFromPathAsync(winDurangoPath);
