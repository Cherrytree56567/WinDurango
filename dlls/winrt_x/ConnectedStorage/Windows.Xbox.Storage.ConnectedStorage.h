  ...
  public:
    ...
    winrt::Windows::Foundation::IAsyncAction Read(
        ...
        winrt::Windows::Foundation::Collections::IMapView<winrt::hstring, winrt::Windows::Storage::Streams::IBuffer>
            data) const;
    winrt::Windows::Foundation::IAsyncAction Upload(
        winrt::hstring containerName,
        winrt::Windows::Foundation::Collections::IMapView<winrt::hstring, winrt::Windows::Storage::Streams::IBuffer>
            blobsToWrite,
    ...
    GetBlobInfoAsync(winrt::hstring parentContainerName, winrt::hstring blobNamePrefix);
    winrt::Windows::Foundation::IAsyncOperation<
    ...
    static winrt::Windows::Foundation::IAsyncAction CreateDirectories(const wchar_t *storageType,
                                                                      winrt::hstring &storagePath);
    static winrt::Windows::Foundation::IAsyncOperation<bool> DoesFolderExist(winrt::hstring path);
    static winrt::Windows::Foundation::IAsyncOperation<bool> DoesFileExist(
