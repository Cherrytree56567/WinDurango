...
D3DINTERFACE(IDXGIDevice, 54ec77fa, 1377, 44e6, 8c, 32, 88, fd, 5f, 44, c8, 4c) : public wd::dxgi_object
{
  public:
    ...
    virtual HRESULT STDMETHODCALLTYPE QueryResourceResidency(_In_reads_(NumResources) IGraphicsUnknown * *ppResources,
                                                             _Out_writes_(NumResources) DXGI_RESIDENCY *
                                                                 pResidencyStatus,
                                                             /* [in] */ UINT NumResources) PURE;
    virtual HRESULT STDMETHODCALLTYPE SetGPUThreadPriority(
        /* [in] */ INT Priority) PURE;
    virtual HRESULT STDMETHODCALLTYPE GetGPUThreadPriority(_Out_ INT * pPriority) PURE;
};
...
{
  public:
    dxgi_device(::IDXGIDevice *device) : wrapped_interface(device)
    {
