...
D3DINTERFACE(ID3D11Device, db6f6ddb, ac77, 4e88, 82, 53, 81, 9d, f9, bb, f1, 40) : public wd::graphics_unknown
{
  public:
    ...
    virtual HRESULT(CreateBuffer)(const D3D11_BUFFER_DESC *pDesc, const D3D11_SUBRESOURCE_DATA *pInitialData,
    ...
    virtual HRESULT(CreateShaderResourceView)(ID3D11Resource * pResource, const D3D11_SHADER_RESOURCE_VIEW_DESC *pDesc,
    ...
    virtual HRESULT(CreateRenderTargetView)(ID3D11Resource * pResource, const D3D11_RENDER_TARGET_VIEW_DESC *pDesc,
                                            ID3D11RenderTargetView **ppRTView) = 0;
    virtual HRESULT(CreateDepthStencilView)(ID3D11Resource * pResource, const D3D11_DEPTH_STENCIL_VIEW_DESC *pDesc,
    ...
    virtual HRESULT(CreateVertexShader)(_In_reads_(BytecodeLength) const void *pShaderBytecode, SIZE_T BytecodeLength,
                                        ID3D11ClassLinkage *pClassLinkage, ID3D11VertexShader **ppVertexShader) = 0;
    virtual HRESULT(CreateGeometryShader)(_In_reads_(BytecodeLength) const void *pShaderBytecode, SIZE_T BytecodeLength,
    ...
    virtual HRESULT(CreatePixelShader)(_In_reads_(BytecodeLength) const void *pShaderBytecode, SIZE_T BytecodeLength,
                                       ID3D11ClassLinkage *pClassLinkage, ID3D11PixelShader **ppPixelShader) = 0;
    virtual HRESULT(CreateHullShader)(_In_reads_(BytecodeLength) const void *pShaderBytecode, SIZE_T BytecodeLength,
                                      ID3D11ClassLinkage *pClassLinkage, ID3D11HullShader **ppHullShader) = 0;
    virtual HRESULT(CreateDomainShader)(_In_reads_(BytecodeLength) const void *pShaderBytecode, SIZE_T BytecodeLength,
                                        ID3D11ClassLinkage *pClassLinkage, ID3D11DomainShader **ppDomainShader) = 0;
    virtual HRESULT(CreateComputeShader)(_In_reads_(BytecodeLength) const void *pShaderBytecode, SIZE_T BytecodeLength,
    ...
    virtual HRESULT(CreatePredicate)(const D3D11_QUERY_DESC *pPredicateDesc, ID3D11Predicate **ppPredicate) = 0;
    virtual HRESULT(CreateCounter)(const D3D11_COUNTER_DESC *pCounterDesc, ID3D11Counter **ppCounter) = 0;
    ...
    virtual HRESULT(CheckCounter)(const D3D11_COUNTER_DESC *pDesc, D3D11_COUNTER_TYPE *pType, UINT *pActiveCounters,
                                  _Out_writes_opt_(*pNameLength) LPSTR szName, _Inout_opt_ UINT *pNameLength,
                                  _Out_writes_opt_(*pUnitsLength) LPSTR szUnits, _Inout_opt_ UINT *pUnitsLength,
    ...
    virtual HRESULT(GetPrivateData)(REFGUID guid, UINT * pDataSize, _Out_writes_bytes_opt_(*pDataSize) void *pData) = 0;
    virtual HRESULT(SetPrivateData)(REFGUID guid, UINT DataSize, _In_reads_bytes_opt_(DataSize) const void *pData) = 0;
...
D3DINTERFACE(ID3D11Device1, a04bfb29, 08ef, 43d6, a4, 9c, a9, bd, bd, cb, e6, 86) : public ID3D11Device
{
  public:
    ...
    virtual HRESULT(CreateBlendState1)(const D3D11_BLEND_DESC1 *pBlendStateDesc, ID3D11BlendState1 **ppBlendState) = 0;
    ...
    virtual HRESULT(OpenSharedResource1)(HANDLE hResource, REFIID ReturnedInterface, void **ppResource) = 0;
    virtual HRESULT(OpenSharedResourceByName)(LPCWSTR lpName, DWORD dwDesiredAccess, REFIID ReturnedInterface,
                                              void **ppResource) = 0;
};
...
D3DINTERFACE(ID3D11Device2, 9d06dffa, d1e5, 4d07, 83, a8, 1b, b1, 23, f2, f8, 41) : public ID3D11Device1
{
  public:
    ...
    virtual void(GetResourceTiling)(
        ...
        D3D11_TILE_SHAPE * pStandardTileShapeForNonPackedMips, _Inout_opt_ UINT * pNumSubresourceTilings,
...
D3DINTERFACE(ID3D11DeviceX, 177700f9, 876a, 4436, b3, 68, 36, a6, 04, f8, 2c, ef) : public ID3D11Device2
{
  public:
    ...
    virtual HRESULT(CreateDepthStencilStateX)(const D3D11_DEPTH_STENCIL_DESC *pDepthStencilStateDesc,
                                              ID3D11DepthStencilState **ppDepthStencilState) = 0;
    virtual HRESULT(CreatePlacementRenderableTexture2D)(
        const D3D11_TEXTURE2D_DESC *pDesc, UINT TileModeIndex, UINT Pitch,
        const D3D11X_RENDERABLE_TEXTURE_ADDRESSES *pAddresses, ID3D11Texture2D **ppTexture2D) = 0;
...
{
  public:
    device_x(::ID3D11Device2 *device) : wrapped_interface(device)
    {
    ...
    HRESULT QueryInterface(REFIID riid, void **ppvObject) override
    {
        ...
        if (riid == __uuidof(wdi::ID3D11DeviceX) || riid == __uuidof(wdi::ID3D11Device) ||
            riid == __uuidof(wdi::ID3D11Device1) || riid == __uuidof(wdi::ID3D11Device2))
        {
    ...
    {
        return wrapped_interface->CreateInputLayout(pInputElementDescs, NumElements, pShaderBytecodeWithInputSignature,
    ...
    {
        return wrapped_interface->CreateGeometryShader(pShaderBytecode, BytecodeLength, pClassLinkage,
                                                       ppGeometryShader);
    }
    ...
    HRESULT CreateGeometryShaderWithStreamOutput(const void *pShaderBytecode, SIZE_T BytecodeLength,
                                                 ...
                                                 ID3D11GeometryShader **ppGeometryShader) override
    {
        return wrapped_interface->CreateGeometryShaderWithStreamOutput(
            pShaderBytecode, BytecodeLength, pSODeclaration, NumEntries, pBufferStrides, NumStrides, RasterizedStream,
    ...
    {
        return wrapped_interface->CheckCounter(pDesc, pType, pActiveCounters, szName, pNameLength, szUnits,
    ...
    {
        return wrapped_interface->CreateDeviceContextState(Flags, pFeatureLevels, FeatureLevels, SDKVersion,
    ...
    HRESULT OpenSharedResourceByName(LPCWSTR lpName, DWORD dwDesiredAccess, REFIID ReturnedInterface,
    ...
    {
        wrapped_interface->GetResourceTiling(pTiledResource, pNumTilesForEntireResource, pPackedMipDesc,
    ...
    HRESULT CreateDepthStencilStateX(const D3D11_DEPTH_STENCIL_DESC *pDepthStencilStateDesc,
                                     ID3D11DepthStencilState **ppDepthStencilState) override;
    HRESULT CreatePlacementRenderableTexture2D(const D3D11_TEXTURE2D_DESC *pDesc, UINT TileModeIndex, UINT Pitch,
