                                  ...
                                  D3D11_MAPPED_SUBRESOURCE *pMappedResource)
{
    ...
    return wrapped_interface->Map(reinterpret_cast<d3d11_resource *>(pResource)->wrapped_interface, Subresource,
...
void wd::device_context_x::PSSetConstantBuffers(UINT StartSlot, UINT NumBuffers, ID3D11Buffer *const *ppConstantBuffers)
{
    ...
    for (UINT i = 0; i < NumBuffers; ++i)
    {
        if (ppConstantBuffers && ppConstantBuffers[i])
        {
            ...
            HRESULT hr =
                ppConstantBuffers[i]->QueryInterface(__uuidof(wdi::ID3D11Buffer), reinterpret_cast<void **>(&wdi_buf));
                                              ...
                                              const UINT *pStrides, const UINT *pOffsets)
{
    ...
    {
        LOG_WARNING("WARN: device_context_x::IASetVertexBuffers: NumBuffers > "
    ...
    if (ppShaderResourceViews != NULL)
    {
        ...
        for (UINT i = 0; i < NumViews; i++)
        {
            if (ppShaderResourceViews[i] == nullptr)
                ...
                modifiedViews[i] =
                    reinterpret_cast<shader_resource_view *>(ppShaderResourceViews[i])->wrapped_interface;
        }
...
void wd::device_context_x::OMSetRenderTargetsAndUnorderedAccessViews(
...
{
    wrapped_interface->CopySubresourceRegion(
        reinterpret_cast<d3d11_resource *>(pDstResource)->wrapped_interface, DstSubresource, DstX, DstY, DstZ,
        reinterpret_cast<d3d11_resource *>(pSrcResource)->wrapped_interface, SrcSubresource, pSrcBox);
}

void wd::device_context_x::CopyResource(ID3D11Resource *pDstResource, ID3D11Resource *pSrcResource)
{
    wrapped_interface->CopyResource(reinterpret_cast<d3d11_resource *>(pDstResource)->wrapped_interface,
                                    reinterpret_cast<d3d11_resource *>(pSrcResource)->wrapped_interface);
}
...
void wd::device_context_x::UpdateSubresource(ID3D11Resource *pDstResource, UINT DstSubresource,
                                             ...
                                             UINT SrcDepthPitch)
{
    wrapped_interface->UpdateSubresource(reinterpret_cast<d3d11_resource *>(pDstResource)->wrapped_interface,
...
void wd::device_context_x::ClearRenderTargetView(ID3D11RenderTargetView *pRenderTargetView, const FLOAT ColorRGBA[4])
{
    ...
    wrapped_interface->ClearRenderTargetView(
        reinterpret_cast<wd::render_target_view *>(pRenderTargetView)->wrapped_interface, ColorRGBA);
}
...
{
    wrapped_interface->ClearDepthStencilView(
        reinterpret_cast<wd::depth_stencil_view *>(pDepthStencilView)->wrapped_interface, ClearFlags, Depth, Stencil);
}
...
{
    wrapped_interface->ResolveSubresource(
        reinterpret_cast<d3d11_resource *>(pDstResource)->wrapped_interface, DstSubresource,
        reinterpret_cast<d3d11_resource *>(pSrcResource)->wrapped_interface, SrcSubresource, Format);
}
...
void wd::device_context_x::IAGetIndexBuffer(ID3D11Buffer **pIndexBuffer, DXGI_FORMAT *Format, UINT *Offset)
{
    ...
    {
        *pIndexBuffer = pIndexBuffer ? reinterpret_cast<ID3D11Buffer *>(new wd::buffer(*pIndexBuffer)) : nullptr;
    }
}
                                              ...
                                              ID3D11DepthStencilView **ppDepthStencilView)
{
    ...
    {
        *ppRenderTargetViews =
            ppRenderTargetViews ? reinterpret_cast<ID3D11RenderTargetView *>(new render_target_view(target)) : nullptr;
    }

    if (ppDepthStencilView != nullptr)
    {
        *ppDepthStencilView =
            ppDepthStencilView ? reinterpret_cast<ID3D11DepthStencilView *>(new depth_stencil_view(depth)) : nullptr;
    }
}
...
{
    wrapped_interface->CopySubresourceRegion1(
        reinterpret_cast<d3d11_resource *>(pDstResource)->wrapped_interface, DstSubresource, DstX, DstY, DstZ,
        reinterpret_cast<d3d11_resource *>(pSrcResource)->wrapped_interface, SrcSubresource, pSrcBox, CopyFlags);
}
...
{
    wrapped_interface->UpdateSubresource1(reinterpret_cast<d3d11_resource *>(pDstResource)->wrapped_interface,
...
void wd::device_context_x::HSSetConstantBuffers1(UINT StartSlot, UINT NumBuffers,
                                                 ...
                                                 const UINT *pNumConstants)
{
    wrapped_interface->HSSetConstantBuffers1(StartSlot, NumBuffers, ppConstantBuffers, pFirstConstant, pNumConstants);
}
...
void wd::device_context_x::DSSetConstantBuffers1(UINT StartSlot, UINT NumBuffers,
                                                 ...
                                                 const UINT *pNumConstants)
{
    wrapped_interface->DSSetConstantBuffers1(StartSlot, NumBuffers, ppConstantBuffers, pFirstConstant, pNumConstants);
}
...
void wd::device_context_x::GSSetConstantBuffers1(UINT StartSlot, UINT NumBuffers,
                                                 ...
                                                 const UINT *pNumConstants)
{
    wrapped_interface->GSSetConstantBuffers1(StartSlot, NumBuffers, ppConstantBuffers, pFirstConstant, pNumConstants);
}
...
void wd::device_context_x::PSSetConstantBuffers1(UINT StartSlot, UINT NumBuffers,
                                                 ...
                                                 const UINT *pNumConstants)
{
    wrapped_interface->PSSetConstantBuffers1(StartSlot, NumBuffers, ppConstantBuffers, pFirstConstant, pNumConstants);
}
...
void wd::device_context_x::CSSetConstantBuffers1(UINT StartSlot, UINT NumBuffers,
                                                 ...
                                                 const UINT *pNumConstants)
{
    wrapped_interface->CSSetConstantBuffers1(StartSlot, NumBuffers, ppConstantBuffers, pFirstConstant, pNumConstants);
}
...
{
    wrapped_interface->VSGetConstantBuffers1(StartSlot, NumBuffers, ppConstantBuffers, pFirstConstant, pNumConstants);
}

void wd::device_context_x::HSGetConstantBuffers1(UINT StartSlot, UINT NumBuffers, ID3D11Buffer **ppConstantBuffers,
                                                 UINT *pFirstConstant, UINT *pNumConstants)
{
    wrapped_interface->HSGetConstantBuffers1(StartSlot, NumBuffers, ppConstantBuffers, pFirstConstant, pNumConstants);
}

void wd::device_context_x::DSGetConstantBuffers1(UINT StartSlot, UINT NumBuffers, ID3D11Buffer **ppConstantBuffers,
                                                 UINT *pFirstConstant, UINT *pNumConstants)
{
    wrapped_interface->DSGetConstantBuffers1(StartSlot, NumBuffers, ppConstantBuffers, pFirstConstant, pNumConstants);
}

void wd::device_context_x::GSGetConstantBuffers1(UINT StartSlot, UINT NumBuffers, ID3D11Buffer **ppConstantBuffers,
                                                 UINT *pFirstConstant, UINT *pNumConstants)
{
    wrapped_interface->GSGetConstantBuffers1(StartSlot, NumBuffers, ppConstantBuffers, pFirstConstant, pNumConstants);
}

void wd::device_context_x::PSGetConstantBuffers1(UINT StartSlot, UINT NumBuffers, ID3D11Buffer **ppConstantBuffers,
                                                 UINT *pFirstConstant, UINT *pNumConstants)
{
    wrapped_interface->PSGetConstantBuffers1(StartSlot, NumBuffers, ppConstantBuffers, pFirstConstant, pNumConstants);
}

void wd::device_context_x::CSGetConstantBuffers1(UINT StartSlot, UINT NumBuffers, ID3D11Buffer **ppConstantBuffers,
                                                 UINT *pFirstConstant, UINT *pNumConstants)
{
    wrapped_interface->CSGetConstantBuffers1(StartSlot, NumBuffers, ppConstantBuffers, pFirstConstant, pNumConstants);
}
...
HRESULT wd::device_context_x::UpdateTileMappings(
...
{
    return wrapped_interface->UpdateTileMappings(reinterpret_cast<d3d11_resource *>(pTiledResource)->wrapped_interface,
                                                 NumTiledResourceRegions, pTiledResourceRegionStartCoordinates,
...
{
    return wrapped_interface->CopyTileMappings(
        reinterpret_cast<d3d11_resource *>(pDestTiledResource)->wrapped_interface, pDestRegionStartCoordinate,
        reinterpret_cast<d3d11_resource *>(pSourceTiledResource)->wrapped_interface, pSourceRegionStartCoordinate,
...
{
    wrapped_interface->CopyTiles(reinterpret_cast<d3d11_resource *>(pTiledResource)->wrapped_interface,
                                 pTileRegionStartCoordinate, pTileRegionSize, pBuffer, BufferStartOffsetInBytes, Flags);
}
...
void wd::device_context_x::UpdateTiles(ID3D11Resource *pDestTiledResource,
                                       ...
                                       UINT Flags)
{
    wrapped_interface->UpdateTiles(reinterpret_cast<d3d11_resource *>(pDestTiledResource)->wrapped_interface,
...
void wd::device_context_x::CSPlaceUnorderedAccessView(UINT Slot,
                                                      wdi::D3D11X_DESCRIPTOR_UNORDERED_ACCESS_VIEW *const pDescriptor,
                                                      UINT64 Offset)
{
    LOG_NOT_IMPLEMENTED();
    throw std::logic_error("Not implemented");
...
void wd::device_context_x::DecompressResource(ID3D11Resource *pDstResource, UINT DstSubresource,
                                              const wdi::D3D11X_POINT *pDstPoint, ID3D11Resource *pSrcResource,
                                              UINT SrcSubresource, const wdi::D3D11X_RECT *pSrcRect,
...
void wd::device_context_x::DecompressResourceX(wdi::D3D11X_DESCRIPTOR_RESOURCE *pDstResource, UINT DstSubresource,
                                               const wdi::D3D11X_POINT *pDstPoint,
                                               wdi::D3D11X_DESCRIPTOR_RESOURCE *pSrcResource, UINT SrcSubresource,
...
HRESULT wd::device_context_x::RSGetMSAASettingsForQuality(wdi::D3D11X_MSAA_SCAN_CONVERTER_SETTINGS *pMSAASCSettings,
                                                          ...
                                                          wdi::D3D11X_MSAA_SAMPLE_POSITIONS *pSamplePositions,
...
void wd::device_context_x::IASetIndexBuffer(UINT HardwareIndexFormat, ID3D11Buffer *pIndexBuffer, UINT Offset)
{
    ...
    wrapped_interface->IASetIndexBuffer(reinterpret_cast<wd::buffer *>(pIndexBuffer)->wrapped_interface, Format,
                                        Offset);
}
                                         ...
                                         UINT64 StartVertexLocationAndStartInstanceLocation, UINT InstanceCount)
{
    ...
    ProcessDirtyFlags();
    wrapped_interface->DrawInstanced(VertexCountPerInstance, InstanceCount, StartVertexLocation, StartInstanceLocation);
}
